...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        String[] arrStr =ContactType.getContactTypes();
        ...
        ArrayList<FilterContactTypeUi> fList=new ArrayList<>();
        for (String strA:arrStr) {
            createFilterContactType(strA);
        }
        ...
        filterContactTypesLiveDate.setValue(fList);
    }
